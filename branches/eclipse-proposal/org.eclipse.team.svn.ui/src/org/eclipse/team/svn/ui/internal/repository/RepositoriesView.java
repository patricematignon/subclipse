...
import org.eclipse.team.svn.ui.internal.actions.SVNAction;
import org.eclipse.team.svn.ui.internal.repository.model.AllRootsElement;
import org.eclipse.team.svn.ui.internal.repository.model.RemoteContentProvider;
import org.eclipse.team.svn.ui.internal.wizards.NewLocationWizard;
...
public class RepositoriesView extends ViewPart implements ISelectionListener {
    ...
    private static final class RepositoryDragSourceListener implements DragSourceListener {
      ...
      public void dragSetData(DragSourceEvent event) {
          if (selection!=null && RemoteResourceTransfer.getInstance().isSupportedType(event.dataType)) {
            ...
            for (int i = 0; i < array.length; i++) {
                if (array[i] instanceof ISVNRemoteResource) {
                    event.data = new PluginTransferData("org.eclipse.team.svn.ui.internal.svnRemoteDrop", RemoteResourceTransfer.getInstance().toByteArray((ISVNRemoteResource) array[i])); //$NON-NLS-1$
                    return;
                }
            }
	...
	/**
	 * @see org.eclipse.team.svn.ui.internal.repo.RemoteViewPart#addWorkbenchActions(org.eclipse.jface.action.IMenuManager)
	 */
...
/*                    IStructuredSelection selection = (IStructuredSelection)getViewer().getSelection();
  ...
  */                   
	...
	/**
	 * @see org.eclipse.team.svn.ui.internal.repo.RemoteViewPart#getHelpContextId()
	 */
