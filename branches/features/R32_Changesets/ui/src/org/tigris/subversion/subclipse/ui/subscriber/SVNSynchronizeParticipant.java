...
public class SVNSynchronizeParticipant extends ScopableSubscriberParticipant implements IChangeSetProvider{
	...
	public ChangeSetCapability getChangeSetCapability() {
        if (capability == null) {
        	...
        	Class changesetCapabilityClass;
			try {
				changesetCapabilityClass = Class.forName("org.tigris.subversion.subclipse.ui.subscriber.SVNChangeSetCapability");
	        	if (changesetCapabilityClass != null) {
	        		capability = (ChangeSetCapability) changesetCapabilityClass.newInstance();
	        	}
